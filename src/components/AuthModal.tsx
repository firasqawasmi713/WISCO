...
import { Mail, Lock, UserCheck, Shield, AlertCircle, Building2 } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="p-6 sm:p-8 space-y-5">
          ...
          <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-400 dark:text-slate-500 pt-2 border-t border-slate-100 dark:border-slate-800">
